...
<main class="panel__contenido">
    <section><h2 class="text-lg">Clientes</h2><p class="texto-tenue">Módulo disponible para administradores y vendedores. El CRUD se implementará en el día 13.</p></section>
</main>
