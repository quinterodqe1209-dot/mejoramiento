...
<main class="panel__contenido">
    <section><h2 class="text-lg">Pedidos</h2><p class="texto-tenue">Módulo disponible para administradores y vendedores. El registro transaccional se implementará en el día 13.</p></section>
</main>
